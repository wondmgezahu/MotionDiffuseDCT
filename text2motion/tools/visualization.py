...
def plot_t2m(data, result_path, npy_path, caption):
    ...
    #  plot_3d_motion(result_path, paramUtil.t2m_kinematic_chain, joint, title=caption, fps=20,radius=5000)
    # plot_3d_motion(result_path, paramUtil.kit_kinematic_chain, joint, title=caption, fps= 12.5,radius=2500)
    if npy_path != "":
...
if __name__ == '__main__':
    ...
    # Assuming 'encoder' is your PyTorch model
    # encoder = build_models(opt).to(device)
