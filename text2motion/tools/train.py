...
if __name__ == '__main__':
    ...
    # import flopth
    # input_shape = (opt.batch_size, opt.max_motion_length)
    # info = flopth.get_info(model, input_shape=(3, 224, 224)) 

    # from calflops import calculate_flops
    # input_shape = (opt.batch_size, opt.max_motion_length)  # define your input shape here
    # flops, macs, params = calculate_flops(encoder, input_shape,include_backPropagation=True)
